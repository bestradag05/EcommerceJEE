				...
				<table class="table table-condensed">
					...
					<tbody>
                                            <c:forEach items="${cart}" var="pro">
                                                <c:set var="total" value="${total+pro.p.precio* pro.cantidad}"/><!-- para crear variables -->
						<tr>
							<td class="cart_product">
								<a href=""><img src="foto/${pro.p.img}" alt=""></a>
							</td>
					...
					<div class="total_area">
						<ul>
							...
							<li>Tax/IVA(19%) <span>$ ${total*0.19}</span></li>
                                                        <li><h3>Total <span>
                                                                <fmt:setLocale value="en_US" />
                                                                    <fmt:formatNumber value="${total*1.19}" type="currency"/>    
